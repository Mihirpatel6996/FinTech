...
async def update_prediction_accuracies(symbol: str):
    ...
    try:
        ...
        with sqlite3.connect("stock_data.db") as conn:
            ...
            # Get predictions made yesterday
            cursor.execute("""
